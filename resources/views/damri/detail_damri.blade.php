               ...
               <div class="container-fluid">
                    ...
                    <div class="column">
                        ...
                        <tr>
                            ...
                            <td><label>{{$angkot->PLATNO}}</label></td>
                        </tr> 
                        <tr>
                            <td><label>Kode Trayek :</label></td>
                            <td><label>{{$angkot->TRAYEK}}</label></td>
                        </tr>
                        <tr><td></td></tr>
                        <tr>
                            <td><label>Code :</label></td>
                            <td><label>{{$angkot->CODE}}</label></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><label>{{$angkot->PNBP_STNK}}</label></td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><label>{{$angkot->KETERANGAN}}</label></td>
                            <td></td>
                            <td></td>
                        </tr>
                        </table>
