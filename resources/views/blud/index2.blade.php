        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-header">
                   {{-- Data Bandros --}}
                    <a href="{{url('/data/bandros/tambah')}}" class="btn btn-primary btn-fill float-right"><i class="fa fa-plus-square"></i> Tambah Data Bandros</a>
                </div>
                @endcan
