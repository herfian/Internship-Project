...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Tambah Data Trans Metro Bandung</h1>
        </div>
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-body row justify-content-center">
                    <div class="col-md-11">
                        <form method="post" action="{{ url('/data/tmb/simpan') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="JENIS_PEMILIK" class="form-control @error('JENIS_PEMILIK') is-invalid @enderror">
                                    <option value="TMB">TRANS METRO BANDUNG</option>
                                </select>
