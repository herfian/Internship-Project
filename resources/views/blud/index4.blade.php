...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Data Trans Metro Bandung</h1>
        </div>
        <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-header">
                   {{-- Data Bus Trans Metro Bandung --}}
                    <a href="{{url('/data/tmb/tambah')}}" class="btn btn-primary btn-fill float-right"><i class="fa fa-plus-square"></i> Tambah Data Bus Trans Metro Bandung</a>
                </div>
                @endcan
