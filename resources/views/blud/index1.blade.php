...
@section('title', 'Data Merah Putih')
        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-header">
                   {{-- Data Bus Merah Putih --}}
                <a href="{{url('/data/bmp/tambah')}}" class="btn btn-primary btn-fill float-right"><i class="fa fa-plus-square"></i> Tambah Data Bus Merah Putih</a>
                </div>
                @endcan
