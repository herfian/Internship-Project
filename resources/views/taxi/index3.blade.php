        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-header">
                   {{-- Data Taksi Primkopau --}}
                <a href="{{url('/data/taxi_pk/tambah')}}" class="btn btn-primary btn-fill float-right"><i class="fa fa-plus-square"></i> Tambah Data Taksi Primkopau</a>
                </div>
                @endcan
...
<script type="text/javascript">
    $(document).ready(function() {
        var table = $(".data-table").DataTable({
            ...
            serverSide: true,
            ordering: false,
            ajax: "{{ route('data.taxi_primkopau.get') }}",
            columns: [
